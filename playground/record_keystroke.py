...
model = load_model('/home/nileshprasad137/academics/miniproject/saved-models/ann.h5')
dataset = pd.read_csv('/home/nileshprasad137/academics/miniproject/dataset/appended/DSL-StrongPasswordData.csv')

subjects = dataset["subject"].unique()
subjects = sorted(subjects)

user_recorded = np.asarray([row_value_list])
# =============================================================================
